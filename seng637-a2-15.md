...
| Method          | Partition | Test Case Name                                                        | Range  | Input | Pass/Fail |
|-----------------|-----------|-----------------------------------------------------------------------|--------|-------|-----------|
| getLength       | 2         | getLength_set_DifferentLowerBoundUpperBound_then_ReturnLength         | (-1,1) | -     | PASS      |
| getLength       | 1         | getLength_set_SameLowerBoundUpperBound_then_ReturnLength              | (1,1)  | -     | PASS      |
| getCentralValue | 2         | getCentralValue_set_DifferentLowerBoundUpperBound_then_ReturnCentralValue | (-1,1) | -     | PASS      |
| getCentralValue | 1         | getCentralValue_set_SameLowerBoundUpperBound_then_ReturnCentralValue  | (1,1)  | -     | PASS      |
| contains        | 1         | contains_given_ValueOfWithinRange_then_ReturnTrue                     | (-1,1) | 0     | PASS      |
| contains        | 5         | contains_given_ValueOfLowerBound_then_ReturnTrue                      | (-1,1) | -1    | PASS      |
| contains        | 4         | contains_given_ValueOfUpperBound_then_ReturnTrue                      | (-1,1) | 1     | PASS      |
| contains        | 2         | contains_given_ValueOfAboveUpperBound_then_ReturnFalse                | (-1,1) | 2     | PASS      |
| contains        | 3         | contains_given_ValueOfBeneathUpperBound_then_ReturnFalse              | (-1,1) | -2    | PASS      |
| getLowerBound   | 1         | getLowerBound_set_LowerBoundNegativeUpperBoundPositive_then_ReturnLowerBound | (-1,1) | -     | PASS      |
| getUpperBound   | 1         | getUpperBound_set_LowerBoundNegativeUpperBoundPositive_then_ReturnUpperBound | (-1,1) | -     | FAIL      |
